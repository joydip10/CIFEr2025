...
### Portfolio selected from DD_Kmeans_2021_lowest_average_clustering

#Import data

```{r}
DD_Kmeans_2021_lowest_average_clustering <- read.csv("~/Desktop/PO/KMEANS/DD/2021/DD_Kmeans_2021_lowest_average_clustering.csv")

#remove the date column
asset_prices<-DD_Kmeans_2021_lowest_average_clustering[,-1]
# calculate returns
...
### Portfolio selected from DD_Kmeans_2021_lowest_risk

#Import data

```{r}
DD_Kmeans_2021_lowest_risk <- read.csv("~/Desktop/PO/KMEANS/DD/2021/DD_Kmeans_2021_lowest_risk.csv")

#remove the date column
asset_prices<-DD_Kmeans_2021_lowest_risk[,-1]
# calculate returns
ret_tidy1 = apply(asset_prices,2, log)
head(ret_tidy1)
ret_tidy2 = diff(ret_tidy1)
...
### Portfolio selected from DD_Kmeans_2021_highest_mean


```{r}
DD_Kmeans_2021_highest_mean <- read.csv("~/Desktop/PO/KMEANS/DD/2021/DD_Kmeans_2021_highest_mean.csv")

#remove the date column
asset_prices<-DD_Kmeans_2021_highest_mean[,-1]
# calculate returns
ret_tidy1 = apply(asset_prices,2, log)
head(ret_tidy1)
ret_tidy2 = diff(ret_tidy1)
