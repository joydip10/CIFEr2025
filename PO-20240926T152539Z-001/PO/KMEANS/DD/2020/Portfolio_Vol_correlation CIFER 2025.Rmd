...
```{r}
DD_Kmeans_2020_lowest_average_clustering <- read.csv("DD_Kmeans_2020_lowest_average_clustering.csv.csv")
...
```{r}
DD_Kmeans_2020_lowest_risk <- read.csv("DD_Kmeans_2020_lowest_risk.csv")
...
```{r}
DD_Kmeans_2020_highest_mean <- read.csv("DD_Kmeans_2020_highest_mean.csv")
