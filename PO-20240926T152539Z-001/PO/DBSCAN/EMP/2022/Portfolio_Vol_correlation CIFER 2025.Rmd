...
```{r}
emperical_DBSCAN_2022_lowest_average_clustering <- read.csv("emperical_DBSCAN_2022_lowest_average_clustering.csv")
...
```{r}
emperical_DBSCAN_2022_lowest_risk <- read.csv("emperical_DBSCAN_2022_lowest_risk.csv")
...
```{r}
emperical_DBSCAN_2022_highest_mean <- read.csv("emperical_DBSCAN_2022_highest_mean.csv")
